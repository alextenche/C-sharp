...
namespace XnaMouseInput
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Texture2D[] character = new Texture2D[4];
        ...
        protected override void LoadContent()
        {
            ...
            character[0] = Content.Load<Texture2D>("character0");
            character[1] = Content.Load<Texture2D>("character1");
            character[2] = Content.Load<Texture2D>("character2");
            character[3] = Content.Load<Texture2D>("character3");
        ...
        protected override void Update(GameTime gameTime)
        {
                ...
                previousButtonState == ButtonState.Pressed)
            {
                ...
                currentCharacter = character[rand.Next(4)];
