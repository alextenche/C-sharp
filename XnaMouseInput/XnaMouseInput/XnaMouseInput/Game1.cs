...
namespace XnaMouseInput
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            characters[0] = Content.Load<Texture2D>("character0");
            characters[1] = Content.Load<Texture2D>("character1");
            characters[2] = Content.Load<Texture2D>("character2");
            characters[3] = Content.Load<Texture2D>("character3");
